...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    AppRegistryAndUpdate: typeof import('./@core/components/AppRegistryAndUpdate.vue')['default']
    ...
    SubscriptionManage: typeof import('./@core/components/SubscriptionManage.vue')['default']
